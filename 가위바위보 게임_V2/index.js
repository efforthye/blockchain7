...
function init(){
    ...
    startBtn.classList.add("displayBlock");
...
function rockPaperScissors(rps){
    ...
    if(comRPS==userRPS){
        ...
        document.getElementsByClassName("bitcoin")[0].classList.add("coinRotateMinus");
        // document.getElementsByClassName("bitcoin")[0].style.transition="all 2s";
        document.getElementsByClassName("bitcoin")[0].classList.add("transition");
    }else{
        let winLose = "";
        ...
        if(winLose=="lose"){
            ...
            setTimeout(()=>{
                ...
                // document.getElementsByClassName("bitcoin")[0].style.transform="rotateY(720deg)";
                document.getElementsByClassName("bitcoin")[0].classList.add("coinRotatePlus");
                // document.getElementsByClassName("bitcoin")[0].style.transition="all 2s";
                document.getElementsByClassName("bitcoin")[0].classList.add("transition");
            ...
            setTimeout(()=>{
                ...
                roulet.classList.add("transition");
            }, 1600);
        }
    }
